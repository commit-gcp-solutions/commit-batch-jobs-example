...
def create_script_job_with_bucket(
    project_id: str, region: str, job_name: str, bucket_name: str, custom_command: str, num_of_parallel_tasks: int
) -> batch_v1.Job:
    """
    ...
    # Open the script file and read its contents into the runnable object
    runnable.script.text = custom_command
